$(function() {	
	$("#form15").submit(function(e) {
		...
		var url_=oElements["restURL"]+"clear";
		...
		var dataSend ="springlesrepositoryID=" +springlesrepositoryID+"&springlesserverURL="+springlesserverURL + "&includenotinferred=" + includenotinferred;
